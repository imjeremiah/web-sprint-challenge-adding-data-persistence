...
Relational Databases consist of tables relating to one another. SQL is the query language for interfacing with RDS.

2. Why do tables need a Primary Key?

To be able to uniquely identify each record in a table.
